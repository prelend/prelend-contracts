// SPDX-License-Identifier: BUSL-1.1validationLogi
...
library ValidationLogic {
    ...
    function validateBorrow(
        ...
        mapping(address => address) storage toActualAsset,
        ...
        if (params.interestRateMode == DataTypes.InterestRateMode.STABLE) {
            ...
            if (!params.reserveCache.reserveConfiguration.getVirtual()) {
                vars.availableLiquidity = IERC20(toActualAsset[params.asset])
                    .balanceOf(params.reserveCache.aTokenAddress);
            }
            ...
            ,
                ...
                .calculateInterestRates(
                    DataTypes.CalculateInterestRatesParams({
                        ...
                        reserveBalance: reserveCache.reserveConfiguration.getVirtual() ? 0 : IERC20(reserveAddress).balanceOf(reserveCache.aTokenAddress)
                    })
                );
