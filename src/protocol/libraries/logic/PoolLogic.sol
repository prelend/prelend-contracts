...
library PoolLogic {
  ...
  function executeInitReserve(
    ...
    mapping(address => address) storage _toVirtualAsset,
    mapping(address => address) storage _toActualAsset,
    ...
    _toVirtualAsset[params.asset] = params.asset;
    if (params.actualAsset != address(0)) {
        _toActualAsset[params.asset] = params.actualAsset;
        _toVirtualAsset[params.actualAsset] = params.actualAsset;
    }
    return true;
  }
