...
contract Main is Script {
    ...
    address usdc = 0x4200000000000000000000000000000000000022;
    address virtualBLAST =
        address(uint160(uint256(keccak256("chrBLAST_underlying_virtual"))));
    ...
    function run() public {
        ...
        addressesProvider = new PoolAddressesProvider("blaze", admin);
        ...
        reserves[0] = ConfiguratorInputTypes.InitReserveInput({
            ...
            rebaseTracker: address(new RebaseTracker(usdc)),
            params: hex""
        });
        ...
        reserves[0] = ConfiguratorInputTypes.InitReserveInput({
            ...
            rebaseTracker: address(new RebaseTracker2(weth)),
            params: hex""
        });
        poolConfig.initReserves(reserves);
